...
class TestNormalize(unittest.TestCase):
    ...
    def test_normalize_ref_template(self):
        self.assertEqual(sentence_tools.normalize('TEMPLATE[refimprove, date=March 2011]   Michael Crichton (October 23, 1942 - November 4, 2008) was an American author of many books.'),'Michael Crichton (October 23, 1942 - November 4, 2008) was an American author of many books.')
